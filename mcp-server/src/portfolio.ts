...
export function effectiveTrailingStop(entryPrice: number, risk: number, currentStopLoss: number, sma20: number | null): number {
...
async function trailingStopCandidate(pos: Position): Promise<number> {
